...
//
// Jede Aktion landet hier - angeklickt in der Oberflaeche, vom Assistenten
// vorgeschlagen oder von einem Programm ueber die API ausgeloest. Das
// Verlaufsfenster haengt per Server-Sent Events dran und sieht es sofort,
// ohne zu pollen.
 ...
 * @param {string} e.quelle   'studio' (Oberflaeche) oder ein Programm von aussen
...
/**
 * Alles, was aufbewahrt wird - neueste zuerst.
 *
 * Fuer das Werkzeug verlauf_lesen, das selbst filtert und dafuer den ganzen
 * Vorrat braucht: wer nach "gestern" fragt, will nicht die letzten 40
 * Eintraege durchsuchen, sondern die von gestern.
 */
export function alle() {
  return eintraege.slice().reverse();
}

/** Wie viele Eintraege hoechstens aufbewahrt werden. */
export const GRENZE = HOECHSTZAHL;
