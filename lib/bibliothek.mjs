 ...
 */
export function bestandFuerAnsicht({
  ordner = null, art = null, nurFavoriten = false, suche = '', vorlage = null,
} = {}) {
  // Filtert auf eine Vorlage, wenn eine genannt ist. Steht vor der Suche,
  // weil es eine harte Zugehoerigkeit ist und keine Textsuche - die Kennung
  // steht im Sidecar und kommt ueber den Eintrag mit herein.
