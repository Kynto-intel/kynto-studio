...
export const OPENROUTER = [
  ...
  // ByteDance Seedance
  { id: 'bytedance/seedance-2.5', name: 'Seedance 2.5', gruppe: 'ByteDance', kannBildEingang: true, notiz: 'BRAUCHT 2K - lehnt 720p und 1080p ab (gemeldet 6.9.2026).' },
  ...
  // MiniMax
  { id: 'minimax/hailuo-3', name: 'MiniMax H3', gruppe: 'MiniMax', kannBildEingang: true, notiz: 'BRAUCHT 2K - lehnt 720p und 1080p ab (gemeldet 6.9.2026).' },
