 ...
 * beim naechsten Mal vorher sagen kann.
 */
const erlaubteAufloesung = new Map();

/** Was das Modell laut Ablehnung annimmt. Leer, wenn nichts dasteht. */
export function bekannteAufloesungen(modell) {
  return erlaubteAufloesung.get(modell) || [];
}
...
function deuteFehler(status, text, modell) {
  ...
  if (erlaubt.length) {
    erlaubteAufloesung.set(modell, erlaubt);
