...
export const OPENROUTER = [
  ...
  { id: 'black-forest-labs/flux.2-pro', name: 'FLUX.2 Pro', gruppe: 'Black Forest Labs', kannReferenz: true, notiz: 'Folgt langen Beschreibungen praeziser als die Banana-Reihe.' },
  ...
  { id: 'bytedance-seed/seedream-5-0-lite', name: 'Seedream 5.0 Lite', gruppe: 'ByteDance', kannReferenz: true, notiz: 'Schneller als 4.5, fuer anweisungsbasierte Aenderungen.' },
  { id: 'bytedance-seed/seedream-4.5', name: 'Seedream 4.5', gruppe: 'ByteDance', kannReferenz: true, notiz: 'Ein Gesicht aus einem Foto in eine neue Szene setzen.' },
  ...
  { id: 'x-ai/grok-imagine-image-2.0', name: 'Grok Imagine Image 2.0', gruppe: 'Weitere', kannReferenz: true, notiz: 'Ausdrucksstark, hoher Kontrast - Anime und Stilisiertes.' },
  ...
  { id: 'recraft/recraft-v4.1-pro', name: 'Recraft V4.1 Pro', gruppe: 'Recraft (Vektor/Logo)', kannReferenz: true, notiz: 'Flaechige Grafik, begrenzte Palette - Logos, Icons, Illustration.' },
  { id: 'recraft/recraft-v4.1', name: 'Recraft V4.1', gruppe: 'Recraft (Vektor/Logo)', kannReferenz: true, notiz: 'Flaechige Grafik mit klaren Kanten, keine Fotos.' },
  ...
  { id: 'recraft/recraft-v4.1-vector', name: 'Recraft V4.1 Vektor', gruppe: 'Recraft (Vektor/Logo)', kannReferenz: true, notiz: 'Vektor-Ausgabe: Kanten fransen auch gross nicht aus.' },
