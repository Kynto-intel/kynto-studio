...
export async function empfohlen(zusaetzlich = null) {
  ...
  // Lokale Modelle zuerst, wenn Ollama laeuft. Nicht weil sie besser waeren,
  // sondern weil sie nichts kosten - wer sie hat, soll sie sehen, bevor er
  // sich fuer etwas Bezahltes entscheidet. Laeuft Ollama nicht, ist die
  // Liste leer und die Gruppe taucht gar nicht erst auf.
  const raus = [...await ollama.alle()];
