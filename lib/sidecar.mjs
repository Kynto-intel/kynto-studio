...
export const LEER = {
  ...
  erstellt: '',
  referenzBild: null,
  // Nur bei Clips gesetzt - ohne sie liesse sich ein Video nicht wiederholen.
  dauer: null,
  aufloesung: null,
  // Nur gesetzt, wenn das Modell das gewuenschte Seitenverhaeltnis nicht
  // konnte und ein anderes gerendert hat. Dann wurde beschnitten.
  verhaeltnis: null,
  eltern: null,
  // Kennung der Vorlage, aus der dieser Lauf kam - leer, wenn er von Hand
  // im Komponisten entstand. Damit kann eine Vorlage zeigen, was sie schon
  // hervorgebracht hat, ohne dass es dafuer einen zweiten Index braucht.
  vorlage: null,
  version: 1,
  favorit: false,
  freigegeben: false,
